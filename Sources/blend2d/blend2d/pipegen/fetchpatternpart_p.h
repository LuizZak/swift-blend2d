...
#ifndef BLEND2D_PIPEGEN_FETCHPATTERNPART_P_H
#define BLEND2D_PIPEGEN_FETCHPATTERNPART_P_H
...
public:
  ...
  //! How many bits to shift the `x` index to get the address to the pixel.
  //! If this value is 0xFF it means that shifting is not possible or that
  //! the pixel was already pre-shifted.
  uint8_t _idxShift;
...
#endif // BLEND2D_PIPEGEN_FETCHPATTERNPART_P_H
