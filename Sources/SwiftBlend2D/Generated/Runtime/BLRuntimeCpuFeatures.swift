...
public extension BLRuntimeCpuFeatures {
    ...
    static let armAsimd = BL_RUNTIME_CPU_FEATURE_ARM_ASIMD
    
    static let armCrc32 = BL_RUNTIME_CPU_FEATURE_ARM_CRC32
    
    static let armPmull = BL_RUNTIME_CPU_FEATURE_ARM_PMULL
}
