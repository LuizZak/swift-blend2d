...
class BLEllipseTests: XCTestCase {
    func testEquals() {
        ...
        XCTAssertNotEqual(
            BLEllipse(cx: 9, cy: 2, rx: 3, ry: 4),
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 4)
        )
        XCTAssertNotEqual(
            BLEllipse(cx: 1, cy: 9, rx: 3, ry: 4),
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 4)
        )
        XCTAssertNotEqual(
            BLEllipse(cx: 1, cy: 2, rx: 9, ry: 4),
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 4)
        )
        XCTAssertNotEqual(
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 9),
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 4)
        )
    }
    ...
    func testHashable() {
        ...
        XCTAssertNotEqual(
            BLEllipse(cx: 9, cy: 2, rx: 3, ry: 4).hashValue,
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 4).hashValue
        )
        XCTAssertNotEqual(
            BLEllipse(cx: 1, cy: 9, rx: 3, ry: 4).hashValue,
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 4).hashValue
        )
        XCTAssertNotEqual(
            BLEllipse(cx: 1, cy: 2, rx: 9, ry: 4).hashValue,
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 4).hashValue
        )
        XCTAssertNotEqual(
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 9).hashValue,
            BLEllipse(cx: 1, cy: 2, rx: 3, ry: 4).hashValue
        )
    }
